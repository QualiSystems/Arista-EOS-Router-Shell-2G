...
from cloudshell.networking.arista.flows.arista_configuration_flow import AristaConfigurationFlow
from cloudshell.networking.arista.flows.arista_connectivity_flow import AristaConnectivityFlow
from cloudshell.networking.arista.flows.arista_load_firmware_flow import AristaLoadFirmwareFlow
from cloudshell.networking.arista.flows.enable_disable_snmp import AristaEnableDisableSNMPFlow
...
from cloudshell.shell.flows.connectivity.parse_request_service import ParseConnectivityRequestService
...
if TYPE_CHECKING:
    from cloudshell.shell.core.driver_context import ResourceCommandContext, AutoLoadCommandContext, AutoLoadDetails, \
        InitCommandContext


class AristaEosRouterShell2GDriver(ResourceDriverInterface, NetworkingResourceDriverInterface):
    SUPPORTED_OS = ["EOS"]
    ...
    def initialize(self, context: InitCommandContext):
        ...
        resource_config = NetworkingResourceConfig.from_context(self.SHELL_NAME, context, None, self.SUPPORTED_OS)
    ...
    def get_inventory(self, context: AutoLoadCommandContext) -> AutoLoadDetails:
        ...
        with LoggingSessionContext(context) as logger:
            ...
            cli_configurator = AristaCLIConfigurator(resource_config, api, logger, self._cli)
            enable_disable_snmp_flow = AristaEnableDisableSNMPFlow(cli_configurator, logger,
    ...
    def run_custom_command(self, context: ResourceCommandContext, custom_command: str) -> str:
        """Send custom command."""
        with LoggingSessionContext(context) as logger:
            api = CloudShellSessionContext(context).get_api()
    ...
    def run_custom_config_command(self, context: ResourceCommandContext, custom_command: str) -> str:
    ...
    def ApplyConnectivityChanges(self, context: ResourceCommandContext, request: str) -> str:
    ...
    def save(self, context: ResourceCommandContext, folder_path: str, configuration_type: str,
             vrf_management_name: str) -> str:
        """Save selected file to the provided destination.

        :param context: ResourceCommandContext object with all Resource Attributes inside
    ...
    @GlobalLock.lock
    def restore(self, context: ResourceCommandContext, path: str, configuration_type: str, restore_method: str,
    ...
    def orchestration_save(self, context: ResourceCommandContext, mode: str, custom_params: str) -> str:
        """
    ...
    def orchestration_restore(self, context: ResourceCommandContext, saved_artifact_info: str,
    ...
    @GlobalLock.lock
    def load_firmware(self, context: ResourceCommandContext, path: str, vrf_management_name: str)->None:
        ...
        with LoggingSessionContext(context) as logger:
            ...
            logger.info(f"Finish Load Firmware")
